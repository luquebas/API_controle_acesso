...
public record UsuarioReturnDTO(Long id, String nome, LocalDate dataNascimento, String matricula, CursoReturnDTO curso, String cpf, String email, String foto, String nivel) {
